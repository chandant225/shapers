                                            ...
                                            <div class="row">
                                                        ...
                                                        <div
                                                            ...
                                                            <label for="dalit"
                                                                ...
                                                                <input
                                                                    ...
                                                                    required>
                                                                <span
                                                                    style="font-size:16px">Dalit</span>
                                                            </label>
                                                            <label for="madhesi"
                                                                class="d-flex align-items-center gap-1">
                                                                <input
                                                                    ...
                                                                    required>
                                                                <span
                                                                    style="font-size:16px">Madhesi</span>
                                                            </label>
                                                            <label
                                                ...
                                                <div
                                                    ...
                                                    <input type="text"
                                                        name="social_media"
                                                        class="question"
                                                        id="social_url" required
                                                        autocomplete="off" />
                                                    <label
                                                        for="social_url"><span>Link
                                                            to your social
                                                            media
                                                ...
                                                <div class="col-lg-12 col-12">
                                                    <input type="text"
                                                        ...
                                                        class="question full-width-m"
                                                        id="know_from" required
                                                        autocomplete="off"
                                                        list="options" />
                                                    <label
                                                        for="know_from"><span>How
                                                            did you get to know
