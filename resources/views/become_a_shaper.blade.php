                        ...
                        <div class="shaper-condition">
                            ...
                            <ul class="mb-3 list-disc">
                                ...
                                <li>
                                    ...
                                    <a
                                        href="https://drive.google.com/file/d/1YrRQ4trNrIY8VkbeZw46Tbw2cAp2f7D_/view?usp=sharing"
                                        target="blanc"
                                        >Hub Charter</a
                                    >
                            ...
                            <ul class="mb-3 list-disc">
                                ...
                                <li>
                                    <p>
                                        ...
                                        ><br />Interview: Shortlisted candidates
                                ...
                                <li>
                                    <p>
                                        ...
                                        ><br />Applicants will be notified of
                                    ...
                                    <div class="form-main">
                                        ...
                                        >
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        >
                                                            ...
                                                            <label
                                                                for="indigenous_ethnic_group"
                                                                class="d-flex align-items-center gap-1"
                                                            >
                                                                <input
                                                                    type="checkbox"
                                                                    id="indigenous_ethnic_group"
                                                                    value="indigenous_ethnic_group"
                                                                    name="group[]"
                                                                    tabindex="1"
                                                                    required
                                                                />
                                                            ...
                                                            <label
                                                                for="physical_mental_disabilities"
                                                                class="d-flex align-items-center gap-1"
                                                            >
                                                                <input
                                                                    type="checkbox"
                                                ...
                                                <div
                                                    class="col-lg-12 col-12 mb-4rem mb-lg-0"
                                                >
                                                    <input
                                                        type="text"
                                                        name="social_media"
                                                ...
                                                <div class="col-lg-12 col-12">
                                                    <input
                                                        ...
                                                        class="question full-width-m"
                                                        id="curr_company"
                                                        required
                                                        autocomplete="off"
                                                    />
                                                    <label for="curr_company"
                                                        ><span
                                                            >If you are
                                                            currently employed,
                                                            please state the
                                                            name of your org<sup
                                                                >*</sup
                                                            ></span
                                                        ></label
                                                    >
