                ...
                <div class="col-lg-3 col-12">
                    <div class="single-footer sm-custom-border f-link">
                        <div class="f-about single-footer">
                            <div class="logo">
                                <a href="/" style="width:100%"><img src={{ asset('pictures/Logo-Inverted.svg') }}
                                        alt="Logo" /></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-3 col-lg-3">
                    <div class="single-footer sm-custom-border f-link">
                        ...
                        <div class="d-flex flex-column">
                            <a href="/application" class="text-white my-1">Become a Shaper</a>
                            <a href="/become_a_partner" class="text-white my-1">Become a Partner</a>
                            <a href="mailto:globalshapersktm@gmail.com" class="text-white my-1">Become a Contributor
                            </a>
                        </div>
                    </div>
                </div>
                                ...
                                <ul class="text-xl">
                                    @if ($social_links->facebook_link)
                                        ...
                                        @endif @if ($social_links->twitter_link)
                                            <li>
                                                <a href="https://{{ $social_links->twitter_link }}" target="blanc"><i
