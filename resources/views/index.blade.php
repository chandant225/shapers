...
@section('content')
  <div>
        ...
        <section class="hero-area style2">
          @if(count($sliders) === 0)
          <center>
            <p class="text-2xl text-red-600 font-bold">There are not any sliders avaliable yet.</p>
          </center>
        ...
        <section class="about-us">
          <div class="container">
            @if(!$slogan)
            <center>
              <p class="text-2xl text-red-600 font-bold">There is no any slogan avaliable yet</p>
            </center>
            @elseif($slogan)
        ...
        <section class="features style2 section">
          <div class="container">
            <div class="row">
              <div class="col-12">
                ...
                <div class="section-title">
                  <h2 class="wow fadeInUp" data-wow-delay=".4s">Hub Verticals</h2>
            ...
            <div class="row">
              @if(count($features) === 0)
              <center>
                <p class="text-2xl text-red-600 font-bold">There is no any features avaliable yet</p>
              </center>
            ...
            <div class="row ">
                <div class="col-lg-8 offset-lg-2 col-12">
                    ...
                    <div class="section-title">
                        ...
                        <h2 class="wow fadeInUp" data-wow-delay=".4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">Subscribe to our newsletter to get latest news on
                            your inbox.</h2>
