            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">
                        The Origin Of Global Shapers Community
                    </h5>
                    <button
                        type="button"
                        class="btn-close"
                ...
                <div class="swiper hub-verticals-swiper">
                    <div style="padding: 20px 0px" class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <!-- single-feature -->
                            <div
                                class="single-feature wow fadeInUp shadow"
                                data-wow-delay=".2s"
                            >
                                <img
            ...
            <div class="join-us">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <img
                            src="{{ asset('pictures/join.jpeg') }}"
                            alt=""
                            class="img-fluid"
                        />
                    </div>
                    <div
                        class="col-lg-6 d-flex flex-column justify-content-around align-items-center"
                        style="padding: 5rem"
                    >
                        <h2
    ...
    <section style="background-color: #f4f7fa" class="our-achievement section">
        <div class="container">
            <div class="row">
                ...
                @elseif(count($counters) >= 1) @foreach ($counters as $counter)
