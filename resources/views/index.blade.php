                                ...
                                <div class="hero-text">
                                    ...
                                    <div class="button wow fadeInUp"
                                        ...
                                        <a href="{{ $slider->video_link }}"
                                            target="_blank" class="video btn"><i
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-12">
                    <div class="about-right wow fadeInRight"
                        data-wow-delay=".4s">
                        <img class="" src="/storage/{{ $slogan->image }}"
                            alt="#" />
                    </div>
                </div>
                <div class="col-lg-6 col-12">
                ...
                <div class="swiper hub-verticals-swiper">
                    <div style="padding: 20px 0px" class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <!-- single-feature -->
                            <div class="single-feature wow fadeInUp shadow"
                                data-wow-delay=".2s">
                                ...
                                <div class="single-testimonial shadow">
                                    <div class="row align-items-center">
                                        <div class="col-lg-12 col-md-12 col-12">
                                            <div
                                                class="testimonial-content text-center">
                                                <p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-12">
                    <div class="single-achievement wow fadeInUp"
                        data-wow-delay=".2s" style="
                            visibility: visible;
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2 col-12">
                    ...
                    <div class="subscribe-text wow fadeInUp"
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2 col-12">
                    <!-- Section-title -->
                    <div class="section-title">
                        <h2 class="wow fadeInDown" data-wow-delay=".2s" style="
                                visibility: visible;
                                animation-delay: 2s;
