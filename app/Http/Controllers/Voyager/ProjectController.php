...
class ProjectController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $project_images = Project_gallery::where('project_id', $id)->get();

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','project_images'));
    }
         ...
         if($request->hasfile('images'))

          {
            foreach($request->file('images') as $image)
            {
                ...
                $image->move(public_path().'/project_gallery/', $name);  
                $project_gallery = new Project_gallery();
                $project_gallery->project_id = $data->id;
                $project_gallery->project_slug = $data->slug;
                $project_gallery->filename=$name;
