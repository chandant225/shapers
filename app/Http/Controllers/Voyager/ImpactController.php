...
class ImpactController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $impact_images = Impact_gallery::where('impacts_id', $id)->get();

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','impact_images'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        Impact_gallery::where('impacts_slug',$data->slug)->delete();
             ...
             if($request->hasfile('images'))
         {
            ...
            foreach($request->file('images') as $image)
            {
                ...
                $image->move(public_path().'/impact_gallery/', $name);  
                $impact_gallery = new Impact_gallery();
                $impact_gallery->impacts_id = $data->id;
                $impact_gallery->impacts_slug = $data->slug;
                $impact_gallery->filename=$name;
                $impact_gallery->save();
            }
         }
